...
import { Briefcase, Lock, Eye, EyeOff, AlertCircle, Loader } from 'lucide-react';
import { updatePassword, verifyResetToken } from '@/services/auth.service';
        ...
        <div className="card p-8 animate-slide-up">
          {isVerifying ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-500 mt-4">Verifying reset link...</p>
            </div>
          ) : !isTokenValid ? (
